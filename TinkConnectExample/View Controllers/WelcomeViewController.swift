...
final class WelcomeViewController: UIViewController {
    ...
    private func submit() {
        ...
        guard let authenticationUrl = AuthorizationUrlBuilder(clientId: Constants.clientId, redirectUri: Constants.redirectUri, scope: Constants.scope, market: market, locale: locale, state: state, iframe: false).build() else {
